namespace BizTalkPrintSystem.Schemas {
    ...
    public sealed class AddAmountByUsername_SOAP1 : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:element name=""AddAmountByUsername"">
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element name=""QuotaCHF"" type=""xs:decimal"" />
      </xs:sequence>
    </xs:complexType>
  </xs:element>
</xs:schema>";
        
        public AddAmountByUsername_SOAP1() {
        }
