namespace BizTalkPrintSystem.Schemas {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"BizTalkPrintSystem.Schemas.SOAP_Account1", typeof(global::BizTalkPrintSystem.Schemas.SOAP_Account1))]
    public sealed class SOAP_Account : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:soapenv=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:tem=""http://tempuri.org/"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" attributeFormDefault=""unqualified"" elementFormDefault=""qualified"" targetNamespace=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:import schemaLocation=""BizTalkPrintSystem.Schemas.SOAP_Account1"" namespace=""http://tempuri.org/"" />
  <xs:annotation>
    <xs:appinfo>
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element name=""Body"">
          <xs:complexType>
            <xs:sequence>
              <xs:element ref=""tem:AddUserResponse"" />
            </xs:sequence>
          </xs:complexType>
        </xs:element>
      </xs:sequence>
